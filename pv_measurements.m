...
legend('11', 'X1', 'X2', 'Xs1', 'Xs2')
subplot(5, 1, 2)
plot(m212_I, m212_V*m212_I, mY1_I, mY1_V*mY1_I, mY2_I, mY2_V*mY2_I, mYs1_I, mYs1_V*mYs1_I, mYs2_I, mYs2_V*mYs2_I)
title('P 2nd maize 2:1')
xlim([0 0.55])
ylim([0 700])
legend('21', 'Y1', 'Y2', 'Ys1', 'Ys2')
subplot(5, 1, 3)
plot(m412_I, m412_V*m412_I, mZ1_I, mZ1_V*mZ1_I, mZ2_I*mZ2_I, mZ2_V*mZ2_V) 
title('P 1st + 2nd maize 4:1')
xlim([0 0.55])
ylim([0 700])
legend('1', '1Z', '2Z')
subplot(5, 1, 4)
plot(m511_I, m511_V*m511_I, m512_I, m512_V*m512_I) %en f?r d?lig
title('P 2nd maize 5:1')
xlim([0 0.55])
ylim([0 700])
subplot(5, 1, 5)
plot(m1011_I, m1011_V*m1011_I, m1012_I, m1012_V*m1012_I, m1013_I, m1013_V*m1013_I)
