...
%I-V 1st+2nd corn
figure
suptitle('Purple corn: current density vs. voltage with potential measurement errors')
subplot(5, 1, 1)
...
figure
suptitle('Purple corn: current density vs. voltage without potential measurement errors')
subplot(5, 1, 1)
...
figure
suptitle('Purple corn: current density vs. power output with potential measurement errors')
subplot(5, 1, 1)
...
figure
suptitle('Purple corn: current density vs. power output without potential measurement errors')
subplot(5, 1, 1)
